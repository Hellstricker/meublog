...
namespace MeuBlog.Mvc.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        private readonly IUserStore<UsuarioAplicacao> _userStore;
        private readonly IUserEmailStore<UsuarioAplicacao> _emailStore;
        ...
        public RegisterModel(
            ...
            IUserStore<UsuarioAplicacao> userStore,
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    var autor = new Autor() { Nome = Input.Nome, UsuarioAplicacaoId = userId };
        ...
        private UsuarioAplicacao CreateUser()
        {
            try
            {
                return Activator.CreateInstance<UsuarioAplicacao>();
            }
            catch
            {
                throw new InvalidOperationException($"Can't create an instance of '{nameof(UsuarioAplicacao)}'. " +
                    $"Ensure that '{nameof(UsuarioAplicacao)}' is not an abstract class and has a parameterless constructor, or alternatively " +
                    $"override the register page in /Areas/Identity/Pages/Account/Register.cshtml");
            }
        }

        private IUserEmailStore<UsuarioAplicacao> GetEmailStore()
        {
            if (!_userManager.SupportsUserEmail)
            {
                throw new NotSupportedException("The default UI requires a user store with email support.");
            }
            return (IUserEmailStore<UsuarioAplicacao>)_userStore;
        }
    }
}
